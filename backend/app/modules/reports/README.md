...
Consultas y agregaciones para dashboard y reportes.

Esta carpeta forma parte del esqueleto del proyecto. El código se agregará al implementar su funcionalidad.

**Responsable del módulo:** Edu Sanchez. La responsabilidad incluye frontend, backend y APIs según [la división del equipo](../../../../docs/team/responsibilities.md).
