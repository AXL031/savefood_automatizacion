...
Consultas y agregaciones para panel y reportes.

Esta carpeta forma parte del esqueleto del proyecto. El código se agregará al implementar su funcionalidad.

**Responsable del módulo:** Edu Sanchez. La responsabilidad incluye interfaz, servidor y APIs según [la división del equipo](../../../../documentacion/equipo/responsabilidades.md).
