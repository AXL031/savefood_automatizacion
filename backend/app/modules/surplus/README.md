...
Detección de excedentes y clasificación del riesgo.

Esta carpeta forma parte del esqueleto del proyecto. El código se agregará al implementar su funcionalidad.

**Responsable del módulo:** Max Rojas. La responsabilidad incluye frontend, backend y APIs según [la división del equipo](../../../../docs/team/responsibilities.md).
