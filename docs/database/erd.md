...
Este ERD conceptual muestra las relaciones entre entidades; todavía no define columnas, tipos ni claves de una migración real. Fuente: sección 11 del documento maestro.
